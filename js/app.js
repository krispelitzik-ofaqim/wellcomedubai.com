...
function renderListPage(category, title, filters, activeFilter) {
  ...
  page.innerHTML = `
    ...
    ` : ''}
    ${contentHTML}
    ${category === 'transport' && active === 'מטרו' ? '' : `<div style="padding:0 16px 12px;margin-top:18px;"><div style="font-size:0.85rem;color:#2C5F6E;font-weight:700;margin-bottom:8px;text-align:right;">📍 מפת סיכום</div><div class="map-container" style="border-radius:12px;overflow:hidden;border:1px solid #E5E7EB;"><div id="listMap" style="width:100%;height:300px;"></div></div>${nearMeToggleHTML()}</div>`}
