...
const DUBAI_AREAS = [
  { name:'דאון טאון & ביזנס ביי', color:'#E76F51', desc:'לב התיירות המודרנית — ברג׳ ח׳ליפה, Dubai Mall, מזרקות דובאי, מגדלי משרדים, מסעדות גורמה ומלונות יוקרה.', poly:[[25.2150,55.2620],[25.2140,55.2840],[25.2050,55.2880],[25.1900,55.2860],[25.1750,55.2820],[25.1700,55.2700],[25.1780,55.2580],[25.1920,55.2540],[25.2080,55.2560]] },
  { name:'מרינה & JBR', color:'#2A9D8F', desc:'רצועת חוף תוססת — יאכטות, טיילת JBR, מסעדות, חיי לילה וגורדי שחקים. נבחרה ע״י Time Out לאחת מ-50 השכונות המגניבות בעולם.', poly:[[25.0980,55.1280],[25.0960,55.1500],[25.0860,55.1560],[25.0700,55.1520],[25.0650,55.1400],[25.0710,55.1280],[25.0830,55.1240]] },
  { name:'פאלם ג׳ומיירה', color:'#B8923A', desc:'אי מלאכותי בצורת דקל — סימן הזיהוי של דובאי. אטרקציות יוקרה: Atlantis, FIVE Palm, Waldorf Astoria. חופים פרטיים ונוף ים.', poly:[[25.1450,55.1350],[25.1450,55.1640],[25.1340,55.1720],[25.1170,55.1720],[25.1020,55.1640],[25.0980,55.1500],[25.1020,55.1360],[25.1170,55.1280],[25.1340,55.1280]] },
  { name:'אל ברשה', color:'#7FA77F', desc:'אזור מרכזי ושקט — קניון Mall of the Emirates, Ski Dubai, מלונות במחירים סבירים, נוח לתחבורה ולשאטלים.', poly:[[25.1300,55.1850],[25.1340,55.2120],[25.1240,55.2240],[25.1080,55.2240],[25.0970,55.2140],[25.0980,55.1960],[25.1100,55.1830]] },
  { name:'ג׳ומיירה ביץ׳', color:'#A86F8E', desc:'25 ק״מ של רצועת חוף — מים טורקיז וחול לבן. החוף הציבורי מצוין למשפחות. ממסגד ג׳ומיירה ועד פאלם ג׳ומיירה.', poly:[[25.2350,55.2280],[25.2310,55.2580],[25.2200,55.2680],[25.2080,55.2640],[25.2000,55.2480],[25.2030,55.2300],[25.2150,55.2220]] },
  { name:'אל וואסל', color:'#5B9DC7', desc:'שכונה אורבנית-בוטיק בלב העיר — Box Park, City Walk, גלריות, מסעדות שף, וילות מודרניות, אווירה איכותית.', poly:[[25.2050,55.2380],[25.2040,55.2540],[25.1960,55.2580],[25.1860,55.2540],[25.1860,55.2420],[25.1950,55.2360]] },
  { name:'טרייד סנטר', color:'#C9A961', desc:'דרך שייח׳ זאיד — שדרת גורדי השחקים. World Trade Center, מלונות עסקיים, רכבת המטרו. קישור מהיר לכל היעדים.', poly:[[25.2280,55.2780],[25.2270,55.2940],[25.2180,55.2980],[25.2090,55.2940],[25.2080,55.2820],[25.2180,55.2760]] },
  { name:'אל ג׳דאף', color:'#6B8E5A', desc:'אזור עולה — בית האופרה, פסטיבל סיטי, גשרים על נחל דובאי, מלונות חדשים. שקט, מתפתח ובמיקום מרכזי.', poly:[[25.2250,55.3160],[25.2240,55.3340],[25.2150,55.3400],[25.2030,55.3360],[25.2010,55.3220],[25.2120,55.3140]] },
  { name:'בור דובאי', color:'#F4A261', desc:'האזור ההיסטורי — שכונת אל-פאהידי, מוזיאון דובאי, נחל דובאי וסירות אברה. תרבות מסורתית במחירים נוחים.', poly:[[25.2730,55.2840],[25.2740,55.3060],[25.2680,55.3180],[25.2560,55.3200],[25.2430,55.3110],[25.2410,55.2960],[25.2480,55.2870]] },
  { name:'דיירה', color:'#B85C8E', desc:'האזור המסורתי והוותיק — שוק הזהב, שוק התבלינים, שוק הטקסטיל. סירות אברה לחציית הנחל. ערך מצוין לכסף.', poly:[[25.2960,55.2920],[25.2990,55.3220],[25.2920,55.3400],[25.2770,55.3470],[25.2620,55.3380],[25.2590,55.3200],[25.2640,55.3030]] }
];
