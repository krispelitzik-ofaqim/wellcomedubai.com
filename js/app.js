            ...
            <div style="display:flex;gap:6px;margin-top:6px;">
              ...
              ${category === 'hotels'
                ...
                : ['attractions','kids','nightlife','transport','casino','abudhabi'].includes(category)
                  ? `<a onclick="event.stopPropagation();openInFrame('https://klook.tpk.lv/8HSINbXI?aff_url=${encodeURIComponent('https://www.klook.com/en-US/search/result/?query=' + encodeURIComponent((item.nameEn || item.name) + ' Dubai'))}','${item.name.replace(/'/g,"\\'")} - רכוש כרטיסים')" style="flex:1;padding:5px;border-radius:4px;border:none;background:#2A9D8F;color:#fff;font-size:0.65rem;text-align:center;text-decoration:none;font-family:Heebo;cursor:pointer;font-weight:700;"><i class="fas fa-ticket-alt"></i> רכוש כרטיסים</a>`
      ...
      <div class="modal-body">
        ...
        <div class="modal-actions" style="flex-wrap:wrap;">
          ...
          ${category !== 'hotels' ? (['attractions','kids','nightlife','transport','casino','abudhabi'].includes(category)
            ? `<a onclick="openInFrame('https://klook.tpk.lv/8HSINbXI?aff_url=${encodeURIComponent('https://www.klook.com/en-US/search/result/?query=' + encodeURIComponent((item.nameEn || item.name) + ' Dubai'))}','${(item.name || '').replace(/'/g,"\\'")} - רכוש כרטיסים')" class="modal-btn primary" style="cursor:pointer;background:#2A9D8F;color:#fff;border:none;"><i class="fas fa-ticket-alt"></i> רכוש כרטיסים</a>`
