            ...
            <div style="display:flex;gap:6px;margin-top:6px;">
              ...
              ${category === 'hotels'
                ...
                : category === 'attractions'
                  ...
                  : `<a href="https://www.google.com/search?q=${encodeURIComponent((item.nameEn || item.name) + ' Dubai menu hours')}" target="_blank" onclick="event.stopPropagation()" style="flex:1;padding:5px;border-radius:4px;border:none;background:#E9C46A;color:#2C5F6E;font-size:0.65rem;text-align:center;text-decoration:none;font-family:Heebo;"><i class="fas fa-info-circle"></i> תפריט</a>`
              }
            </div>
          </div>
        </div>`;
