...
const TOP_ISRAELI_PRODUCTS = [
  ...
  { cat:'אלקטרוניקה', emoji:'📱', color:'#1A6B8A', items:[
    ...
    { name:'Jumbo — Dubai Mall', desc:'מבחר רחב, שירות אמין', rating:'⭐ 4.6', lat:25.1972, lng:55.2796, image:'https://logo.clearbit.com/jumbo.ae', web:'https://www.jumbo.ae', map:'https://maps.google.com/?q=Jumbo+Electronics+Dubai+Mall' },
    { name:'Lulu Electronics — Karama', desc:'מחירים תחרותיים בקניונים', rating:'⭐ 4.4', lat:25.2510, lng:55.3115, image:'https://logo.clearbit.com/luluhypermarket.com', web:'https://www.luluhypermarket.com', map:'https://maps.google.com/?q=Lulu+Hypermarket+Karama+Dubai' },
    { name:'Dubai Mall — Electronics Floor', desc:'Apple, Samsung, Sony — חנויות רשמיות', rating:'⭐ 4.8', lat:25.1972, lng:55.2796, image:'https://logo.clearbit.com/thedubaimall.com', web:'https://thedubaimall.com', map:'https://maps.google.com/?q=Dubai+Mall' },
  ]},
];
