...
const TOP_ISRAELI_PRODUCTS = [
  { cat:'זהב ותכשיטים', emoji:'💍', color:'#E9C46A', items:[
    ...
    { name:'Malabar Gold — Karama', desc:'בחירה רחבה במחירים תחרותיים', rating:'⭐ 4.5', lat:25.2497, lng:55.3083, image:'https://images.unsplash.com/photo-1535632066274-50c97a418ed7?w=400&h=400&fit=crop&q=80', web:'https://www.malabargoldanddiamonds.com', map:'https://maps.google.com/?q=Malabar+Gold+Karama+Dubai' },
  ]},
  ...
  { cat:'תמרים וממתקים', emoji:'🌴', color:'#A0522D', items:[
    { name:'Bateel — Dubai Mall', desc:'תמרים מובחרים באריזות מתנה — מתנה אהובה', rating:'⭐ 4.8', lat:25.1973, lng:55.2796, image:'https://images.unsplash.com/photo-1601379760883-1bb497d806dd?w=400&h=400&fit=crop&q=80', web:'https://www.bateel.com', map:'https://maps.google.com/?q=Bateel+Dubai+Mall' },
    ...
    { name:'Al Aseel Sweets', desc:'תמרים וממתקים ערביים מסורתיים', rating:'⭐ 4.6', lat:25.2300, lng:55.3219, image:'https://images.unsplash.com/photo-1610915127867-0d6e4d1ea3df?w=400&h=400&fit=crop&q=80', web:'https://www.alaseelrestaurants.com', map:'https://maps.google.com/?q=Al+Aseel+Sweets+Dubai' },
