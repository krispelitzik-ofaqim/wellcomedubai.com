...
const DUBAI_AREAS = [
  { name:'1. דאון טאון & ביזנס ביי', color:'#E76F51', desc:'לב התיירות המודרנית — ברג׳ ח׳ליפה, Dubai Mall, מזרקות דובאי, מגדלי משרדים, מסעדות גורמה ומלונות יוקרה.', poly:[[25.2080,55.2620],[25.2070,55.2790],[25.1850,55.2880],[25.1700,55.2820],[25.1690,55.2680],[25.1830,55.2570],[25.2000,55.2570]] },
  { name:'2. מרינה & JBR', color:'#2A9D8F', desc:'רצועת חוף תוססת — יאכטות, טיילת JBR, מסעדות, חיי לילה וגורדי שחקים. נבחרה ע״י Time Out לאחת מ-50 השכונות המגניבות בעולם.', poly:[[25.0980,55.1300],[25.0950,55.1480],[25.0820,55.1560],[25.0680,55.1500],[25.0660,55.1380],[25.0780,55.1280],[25.0900,55.1260]] },
  { name:'3. פאלם ג׳ומיירה', color:'#B8923A', desc:'אי מלאכותי בצורת דקל — סימן הזיהוי של דובאי. אטרקציות יוקרה: Atlantis, FIVE Palm, Waldorf Astoria. חופים פרטיים ונוף ים.', poly:[[25.1430,55.1350],[25.1430,55.1640],[25.1340,55.1720],[25.1170,55.1720],[25.1020,55.1640],[25.0980,55.1500],[25.1020,55.1360],[25.1170,55.1280],[25.1340,55.1280]] },
  { name:'4. אל ברשה', color:'#7FA77F', desc:'אזור מרכזי ושקט — קניון Mall of the Emirates, Ski Dubai, מלונות במחירים סבירים, נוח לתחבורה ולשאטלים.', poly:[[25.1180,55.1880],[25.1190,55.2080],[25.1100,55.2200],[25.0980,55.2200],[25.0890,55.2120],[25.0900,55.1960],[25.1020,55.1880]] },
  { name:'5. ג׳ומיירה ביץ׳', color:'#A86F8E', desc:'רצועת חוף ארוכה — מים טורקיז וחול לבן. ממסגד ג׳ומיירה ועד צפון פאלם ג׳ומיירה. רחובות וילות שקטים.', poly:[[25.2280,55.2280],[25.2230,55.2400],[25.2050,55.2510],[25.1830,55.2370],[25.1610,55.2200],[25.1400,55.2010],[25.1300,55.1900],[25.1380,55.1830],[25.1620,55.2010],[25.1860,55.2200],[25.2080,55.2330]] },
  { name:'6. אל וואסל', color:'#5B9DC7', desc:'שכונה אורבנית-בוטיק בלב העיר — Box Park, City Walk, גלריות, מסעדות שף, וילות מודרניות, אווירה איכותית.', poly:[[25.2030,55.2360],[25.2030,55.2510],[25.1940,55.2560],[25.1850,55.2520],[25.1850,55.2400],[25.1940,55.2340]] },
  { name:'7. טרייד סנטר', color:'#C9A961', desc:'דרך שייח׳ זאיד — שדרת גורדי השחקים. World Trade Center, מלונות עסקיים, רכבת המטרו. קישור מהיר לכל היעדים.', poly:[[25.2300,55.2620],[25.2290,55.2800],[25.2200,55.2820],[25.2110,55.2800],[25.2100,55.2640],[25.2200,55.2600]] },
  { name:'8. אל ג׳דאף', color:'#6B8E5A', desc:'אזור עולה — בית האופרה, פסטיבל סיטי, גשרים על נחל דובאי, מלונות חדשים. שקט, מתפתח ובמיקום מרכזי.', poly:[[25.2280,55.3110],[25.2270,55.3300],[25.2170,55.3340],[25.2050,55.3300],[25.2050,55.3140],[25.2160,55.3080]] },
  { name:'9. בור דובאי', color:'#F4A261', desc:'האזור ההיסטורי — שכונת אל-פאהידי, מוזיאון דובאי, נחל דובאי וסירות אברה. תרבות מסורתית במחירים נוחים.', poly:[[25.2620,55.2880],[25.2620,55.3080],[25.2530,55.3160],[25.2410,55.3140],[25.2360,55.3050],[25.2390,55.2920],[25.2490,55.2860]] },
  { name:'10. דיירה', color:'#B85C8E', desc:'האזור המסורתי והוותיק — שוק הזהב, שוק התבלינים, שוק הטקסטיל. סירות אברה לחציית הנחל. ערך מצוין לכסף.', poly:[[25.2820,55.3160],[25.2820,55.3360],[25.2710,55.3420],[25.2620,55.3380],[25.2590,55.3260],[25.2660,55.3170],[25.2760,55.3140]] }
];
  ...
  if (typeof google !== 'undefined' && google.maps && map.setOptions) {
    ...
    DUBAI_AREAS.forEach(a => {
      const poly = new google.maps.Polygon({
        ...
        strokeColor: a.color, strokeOpacity:0.95, strokeWeight:3,
        fillColor: a.color, fillOpacity:0.38, map: map, clickable:true
      });
          ...
          <div style="padding:10px;">
            ...
            <div style="display:flex;gap:6px;margin-top:6px;">
              ...
              ${category === 'hotels'
                ...
                : ['attractions','kids','nightlife','transport','casino','abudhabi'].includes(category)
                  ? `<a href="https://klook.tpk.lv/8HSINbXI" target="_blank" rel="noopener" data-no-iframe="1" onclick="event.stopPropagation()" style="flex:1;padding:5px;border-radius:4px;border:none;background:#2A9D8F;color:#fff;font-size:0.65rem;text-align:center;text-decoration:none;font-family:Heebo;cursor:pointer;font-weight:700;"><i class="fas fa-ticket-alt"></i> רכוש כרטיסים</a>`
...
const RE_BROKERS_DEFAULT = [
  { id:'b1', type:'broker', name:'גלית שמש', company:'Allsopp & Allsopp', langs:['עברית','אנגלית','ערבית'], phone:'+971-50-100-2233', whatsapp:'971501002233', specialty:'Marina, JBR, JLT', email:'galit@allsopp.ae', years:'8 שנים', verified:true, image:'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&q=80' },
  { id:'b2', type:'broker', name:'אבי כהן', company:'Better Homes', langs:['עברית','אנגלית'], phone:'+971-55-222-3344', whatsapp:'971552223344', specialty:'Downtown, Business Bay', email:'avi@betterhomes.ae', years:'6 שנים', verified:true, image:'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=200&q=80' },
  { id:'b3', type:'broker', name:'מיכאל רובין', company:'Engel & Völkers', langs:['עברית','אנגלית','רוסית'], phone:'+971-52-333-4455', whatsapp:'971523334455', specialty:'Palm, Emirates Hills, יוקרה', email:'michael@ev-dubai.ae', years:'12 שנים', verified:true, image:'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&q=80' },
  { id:'b4', type:'broker', name:'שרה לוי', company:'Driven Properties', langs:['עברית','אנגלית'], phone:'+971-58-444-5566', whatsapp:'971584445566', specialty:'JVC, Damac Hills, השקעות זולות', email:'sarah@drivenproperties.ae', years:'5 שנים', verified:true, image:'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&q=80' },
  { id:'a1', type:'accountant', name:'דניאל אברהם', company:'PwC Middle East', langs:['עברית','אנגלית'], phone:'+971-50-555-6677', whatsapp:'971505556677', specialty:'מס חברות, מע"מ, רואה חשבון לישראלים', email:'daniel@pwc.ae', years:'10 שנים', verified:true, image:'https://images.unsplash.com/photo-1556157382-97eda2f9e2bf?w=200&q=80' },
  { id:'a2', type:'accountant', name:'רון מזרחי', company:'KPMG Lower Gulf', langs:['עברית','אנגלית','ערבית'], phone:'+971-55-666-7788', whatsapp:'971556667788', specialty:'תכנון מס בינלאומי, חברות LLC, Free Zone', email:'ron@kpmg.ae', years:'7 שנים', verified:true, image:'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=200&q=80' },
  { id:'l1', type:'lawyer', name:'תמר ניסים', company:'Al Tamimi & Co.', langs:['עברית','אנגלית','ערבית'], phone:'+971-50-888-9900', whatsapp:'971508889900', specialty:'נדל"ן, חברות, חוזים, רגולציה אמירויות', email:'tamar@tamimi.ae', years:'9 שנים', verified:true, image:'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=200&q=80' },
  { id:'l2', type:'lawyer', name:'יוסי בן-דוד', company:'BSA Ahmad Bin Hezeem', langs:['עברית','אנגלית'], phone:'+971-52-777-8899', whatsapp:'971527778899', specialty:'הסכמי השקעה, ויזות עסקים, גירושין/ירושה', email:'yossi@bsabh.ae', years:'14 שנים', verified:true, image:'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&q=80' }
];
  ...
  return `
    ...
    <div style="background:linear-gradient(180deg,#0E2A38 0%,#1A4A5E 100%);padding:14px 16px 22px;">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;">
        ...
        <div style="color:rgba(255,255,255,0.55);font-size:0.65rem;font-family:'SF Mono',Menlo,monospace;">LIVE • Q2 2026</div>
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;">
        <div style="background:rgba(255,255,255,0.06);border:1px solid rgba(233,196,106,0.25);border-radius:10px;padding:10px 8px;">
          <div style="color:rgba(255,255,255,0.55);font-size:0.62rem;font-weight:600;margin-bottom:4px;">מחיר ממוצע למ"ר</div>
          <div style="color:#fff;font-size:1.05rem;font-weight:800;font-family:'SF Mono',Menlo,monospace;">AED 1,580</div>
          <div style="color:#4ADE80;font-size:0.68rem;font-weight:700;margin-top:2px;">▲ 19.8% YoY</div>
        </div>
        <div style="background:rgba(255,255,255,0.06);border:1px solid rgba(233,196,106,0.25);border-radius:10px;padding:10px 8px;">
          <div style="color:rgba(255,255,255,0.55);font-size:0.62rem;font-weight:600;margin-bottom:4px;">תשואה ממוצעת</div>
          <div style="color:#fff;font-size:1.05rem;font-weight:800;font-family:'SF Mono',Menlo,monospace;">8.2%</div>
          <div style="color:#4ADE80;font-size:0.68rem;font-weight:700;margin-top:2px;">▲ 0.6pt YoY</div>
        </div>
        <div style="background:rgba(255,255,255,0.06);border:1px solid rgba(233,196,106,0.25);border-radius:10px;padding:10px 8px;">
          <div style="color:rgba(255,255,255,0.55);font-size:0.62rem;font-weight:600;margin-bottom:4px;">AED / ILS</div>
          <div style="color:#fff;font-size:1.05rem;font-weight:800;font-family:'SF Mono',Menlo,monospace;">0.998</div>
          <div style="color:#F87171;font-size:0.68rem;font-weight:700;margin-top:2px;">▼ 0.4% MoM</div>
        </div>
      </div>
    </div>
    ` : ''}
  ...
  page.innerHTML = `
    ...
    <div style="padding:14px 16px 80px;background:#FDF6EC;">
      ${tab === 'articles' ? (renderREArticlesWithStats() + renderBrokersBannerBottom())
        ...
        : tab === 'israeli' ? (renderIsraeliInvestments() + renderBrokersBannerBottom())
...
function renderIsraeliInvestments() {
  const stats = [
    ...
    { val:'3', label:'חברות תעופה ישראליות לדובאי (אל על, ארקיע, ישראייר)', color:'#E76F51' },
    { val:'1', label:'חברת תעופה ישראלית לאבו דאבי (אל על)', color:'#A86F8E' },
  ...
  const sectors = [
    ...
    { icon:'💧', name:'טכנולוגיית מים', desc:'IDE Technologies, Watergen — אמירויות הן השוק הטבעי לחדשנות מים.', kpi:'5+ פרויקטים' },
    { icon:'🌱', name:'חקלאות מדברית', desc:'Netafim, Plantish — שיתופי פעולה בחממות חכמות וחלבונים אלטרנטיביים.', kpi:'3+ JVs' },
    { icon:'🏥', name:'רפואה ובריאות', desc:'שיתופי מחקר, חיסונים, תיירות מרפא ויבוא ציוד רפואי ישראלי.', kpi:'גדל 40%/שנה' }
  ];
  const topAreas = [
  ...
  const funds = [
    { name:'OurCrowd', desc:'משרד דובאי מאז 2021 — חיבור משקיעים ישראלים-מפרציים בסטארטאפים', tag:'VC' },
    { name:'Pitango', desc:'נציגות אמירויות לחיבור פורטפוליו לשוק המקומי', tag:'VC' },
    { name:'G42 Israeli Fund', desc:'קרן השקעות ישירה של G42 (אמירויות) בסטארטאפים ישראליים', tag:'CVC' },
...
function renderBusinessPortal() {
  ...
  page.innerHTML = `
    ...
    <div style="padding:18px 16px 80px;background:#FAF6EE;">
      <div style="font-weight:900;color:#1A4A5E;font-size:1.05rem;margin:0 0 12px;letter-spacing:-0.3px;">חדשות עסקים מדובאי</div>
      <div id="bizNewsSlider" class="thin-slider" style="display:flex;gap:10px;overflow-x:auto;scroll-snap-type:x mandatory;padding-bottom:8px;margin-bottom:22px;"><div style="padding:20px;color:#6B7F8D;text-align:center;width:100%;">⏳ טוען...</div></div>

      <div style="font-weight:900;color:#1A4A5E;font-size:1.05rem;margin:18px 0 12px;letter-spacing:-0.3px;">זהב (XAU/USD)</div>
      <div style="background:#fff;border-radius:12px;padding:10px;margin-bottom:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
      ...
      <div style="font-weight:900;color:#1A4A5E;font-size:1.05rem;margin:18px 0 12px;letter-spacing:-0.3px;">כסף (XAG/USD)</div>
      <div style="background:#fff;border-radius:12px;padding:10px;margin-bottom:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
        <iframe scrolling="no" allowtransparency="true" frameborder="0" style="width:100%;height:300px;border:0;" src="https://www.tradingview-widget.com/embed-widget/symbol-overview/?locale=en#%7B%22symbols%22%3A%5B%5B%22OANDA%3AXAGUSD%7C1Y%22%5D%5D%2C%22chartOnly%22%3Afalse%2C%22width%22%3A%22100%25%22%2C%22height%22%3A300%2C%22colorTheme%22%3A%22light%22%7D"></iframe>
      </div>

      <div style="font-weight:900;color:#1A4A5E;font-size:1.05rem;margin:18px 0 12px;letter-spacing:-0.3px;">נפט (US Oil)</div>
      <div style="background:#fff;border-radius:12px;padding:10px;margin-bottom:14px;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
        ...
        return `
          <div style="margin-bottom:42px;">
            <div style="display:flex;align-items:baseline;gap:14px;margin-bottom:14px;">
              <div style="font-weight:300;font-size:2.4rem;color:${isCurrent?'#E76F51':'#2C5F6E'};letter-spacing:-1px;line-height:1;">${m}</div>
              <div style="color:#9CA3AF;font-size:0.78rem;font-weight:500;">${events.length ? events.length + ' אירועים' : ''}${isCurrent ? ' · החודש' : ''}</div>
              <div style="flex:1;height:1px;background:rgba(184,146,58,0.3);"></div>
            </div>
            ${futureYear ? `<div style="color:#9CA3AF;font-size:0.88rem;padding:18px 0;line-height:1.7;font-style:italic;">לוח אירועים עדכני ייטען עם פתיחת קופות הכרטיסים</div>` : events.length === 0 ? '' : events.map(e => {
              const parts = String(e.day).split('.');
              const dayPart = parts[0] || e.day;
              const monthShort = HEB_MONTHS[parseInt(parts[1]) || monthNum] || '';
              return `
                <div style="display:flex;gap:18px;padding:18px 0;border-bottom:1px solid rgba(184,146,58,0.15);">
                  <div style="flex-shrink:0;text-align:center;min-width:60px;border-left:1px solid rgba(184,146,58,0.4);padding-left:14px;">
                    <div style="font-weight:800;font-size:1.4rem;color:#2C5F6E;line-height:1;">${dayPart}</div>
                    <div style="font-size:0.65rem;color:#B8923A;font-weight:600;text-transform:uppercase;letter-spacing:1px;margin-top:4px;">${monthShort.slice(0,3) || HEB_MONTHS[monthNum].slice(0,3)}</div>
                  </div>
                  <div style="flex:1;min-width:0;">
  ...
  return `
    <div onclick="switchRETab('brokers-full')" style="margin-top:22px;border-radius:16px;cursor:pointer;aspect-ratio:380/120;background-image:linear-gradient(90deg,rgba(184,92,142,0.85) 0%,rgba(26,107,138,0.6) 100%),url('images/wellcomedubai.stamp/lifestyle-business-woman-feel-happy-jumping-air-celebrating-success.jpg');background-size:cover;background-position:center;display:flex;align-items:center;justify-content:space-between;padding:0 22px;box-shadow:0 8px 24px rgba(184,92,142,0.3);overflow:hidden;box-sizing:border-box;border:1px solid rgba(255,255,255,0.15);position:relative;">
      ...
      <div style="color:#fff;text-shadow:0 2px 8px rgba(0,0,0,0.6);position:relative;">
        ...
        <div style="font-weight:800;font-size:1.05rem;line-height:1.15;">מתווכים / רוא"ח / עורכי דין</div>
...
function renderBrokersFullPage() {
  ...
  if (!page) return;
  page.innerHTML = `
    ${renderREHeader('', { showHero:false, subtitle:'מתווכים / רוא"ח / עורכי דין', backAction:"switchRETab('invest')" })}
    <div style="display:flex;gap:8px;padding:12px 14px;background:#FDF6EC;border-bottom:1px solid #E8DEC8;">
      <button onclick="showBrokerCriteria()" style="flex:1;padding:11px;border-radius:8px;font-family:Heebo;font-weight:700;font-size:0.82rem;cursor:pointer;background:#fff;border:2px solid #1A6B8A;color:#1A6B8A;">✓ נדרש לאימות</button>
      <button onclick="showBrokerSubmit()" style="flex:1;padding:11px;border-radius:8px;font-family:Heebo;font-weight:700;font-size:0.82rem;cursor:pointer;background:#B85C8E;border:none;color:#fff;">+ המלץ על איש מומחה</button>
    </div>
    <div style="padding:14px 16px 80px;background:#FDF6EC;">
      ${renderREBrokers()}
    </div>
  ...
  page.innerHTML = `
    ...
    <div style="padding:12px 14px 80px;">
      <div style="background:#000;border-radius:10px;overflow:hidden;position:relative;aspect-ratio:4/3;margin-bottom:18px;">
        ...
        <div style="position:absolute;bottom:14px;right:14px;background:rgba(0,0,0,0.55);backdrop-filter:blur(4px);padding:5px 10px;border-radius:8px;border:1px solid rgba(233,196,106,0.5);"><span style="color:#E9C46A;font-weight:900;font-size:0.7rem;letter-spacing:0.5px;">© WellCome Dubai</span></div>
        ${images.length > 1 ? `
      ...
      <div style="font-weight:700;color:#2C5F6E;font-size:0.85rem;margin:6px 0 8px;">כל התמונות (${images.length})</div>
      <div class="thin-slider" style="display:flex;gap:6px;overflow-x:auto;padding-bottom:6px;">
        ${images.map((name, i) => `
          <div onclick="openGalleryAt(${i})" style="width:74px;height:74px;border-radius:6px;overflow:hidden;cursor:pointer;flex-shrink:0;border:${i === cur ? '2px solid #E76F51' : '1px solid #E5E7EB'};">
            <img src="${galleryImgUrl(name)}" loading="lazy" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.style.display='none'">
          </div>
        `).join('')}
      </div>
    ...
    <div class="modal-sheet">
      ...
      <div class="modal-body">
        ...
        <div class="modal-actions" style="flex-wrap:wrap;">
          ...
          ${category !== 'hotels' ? (['attractions','kids','nightlife','transport','casino','abudhabi'].includes(category)
            ? `<a href="https://klook.tpk.lv/8HSINbXI" target="_blank" rel="noopener" data-no-iframe="1" class="modal-btn primary" style="background:#2A9D8F;"><i class="fas fa-ticket-alt"></i> רכוש כרטיסים</a>`
